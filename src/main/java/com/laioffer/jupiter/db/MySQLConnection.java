...
public class MySQLConnection {
    ...
    public void setFavoriteItem(String userId, Item item) throws MySQLException {
        ...
        // userID is definitely available as user needs to log in before saving fav
        saveItem(item);
    ...
    // We did not delete the unset item from db as it slows down the operation, affect user experience
    // Occasionally perform GC to remove unset items from db to free up space
    ...
    // Get favorite game ids for the given user.
    // The returned map includes three entries like {"Video": ["1234", "5678", ...], "Stream": ["abcd", "efgh", ...], "Clip": ["4321", "5678", ...]}
